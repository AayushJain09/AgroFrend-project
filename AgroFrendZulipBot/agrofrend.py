...
from zulip_bots.bots.AgroFrend import utils
...
def get_bot_converter_response(message: Dict[str, str], bot_handler: BotHandler) -> str:
    ...
    convert_indexes = [i for i, word in enumerate(words) if word == "@AgroFrend"]
...
handler_class = AgroFrendHandler
