...
![MIT](https://img.shields.io/github/license/AgroFrendHackfest/ReactWebsite?color=blue)
...
```sh
git remote add upstream https://github.com/AgroFrendHackfest/ReactWebsite.git
```
...
origin	https://github.com/Your_Username/ReactWebsite.git (fetch)
origin	https://github.com/Your_Username/ReactWebsite.git (push)
upstream	https://github.com/AgroFrendHackfest/ReactWebsite (fetch)
upstream	https://github.com/AgroFrendHackfest/ReactWebsite (push)
```
